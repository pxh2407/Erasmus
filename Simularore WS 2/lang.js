...
const TRANSLATIONS = {
  it: {
    ...
    footer_text: "Progetto Erasmus+ · Simulation Game — Sprechi alimentari", footer_cookie: "Cookie Policy", footer_credit: "Progetto web LUTE MILAZZO — curato da Filippo Russo Nuccio",
    btn_top: "Inizio",
  ...
  en: {
    ...
    footer_text: "Erasmus+ Project · Simulation Game — Food Waste", footer_cookie: "Cookie Policy", footer_credit: "LUTE MILAZZO web project — by Filippo Russo Nuccio",
    btn_top: "Top",
  ...
  pl: {
    ...
    footer_text: "Projekt Erasmus+ · Gra symulacyjna — Marnowanie żywności", footer_cookie: "Cookie Policy", footer_credit: "Projekt strony LUTE MILAZZO — wykonał Filippo Russo Nuccio",
    btn_top: "Góra",
  ...
  de: {
    ...
    footer_text: "Erasmus+-Projekt · Simulationsspiel — Lebensmittelverschwendung", footer_cookie: "Cookie Policy", footer_credit: "LUTE MILAZZO-Webprojekt — von Filippo Russo Nuccio",
    btn_top: "Oben",
  ...
  lv: {
    ...
    footer_text: "Erasmus+ projekts · Simulācijas spēle — Pārtikas izšķērdēšana", footer_cookie: "Cookie Policy", footer_credit: "LUTE MILAZZO tīmekļa projekts — veidoja Filippo Russo Nuccio",
    btn_top: "Augšā",
