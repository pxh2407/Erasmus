...
(function () {
  ...
  // ============================================================
  var it = [
    { id:1, title:"L'Unione Europea", subtitle:"Una comunità di valori, pace e prosperità", banner:"Erasmus+ · ECBL",
      sections:[
  ...
  // ============================================================
  var en = [
    { id:1, title:"The European Union", subtitle:"A community of values, peace and prosperity", banner:"Erasmus+ · ECBL",
      sections:[
  ...
  // ============================================================
  var pl = [
    { id:1, title:"Unia Europejska", subtitle:"Wspólnota wartości, pokoju i dobrobytu", banner:"Erasmus+ · ECBL",
      sections:[
  ...
  // ============================================================
  var de = [
    { id:1, title:"Die Europäische Union", subtitle:"Eine Gemeinschaft der Werte, des Friedens und des Wohlstands", banner:"Erasmus+ · ECBL",
      sections:[
  ...
  // ============================================================
  var lv = [
    { id:1, title:"Eiropas Savienība", subtitle:"Vērtību, miera un labklājības kopiena", banner:"Erasmus+ · ECBL",
      sections:[
